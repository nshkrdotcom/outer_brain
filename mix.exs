  ...
  defp aliases do
    ...
    [
      ...
      "weld.release.prepare": [
        "weld.release.prepare build_support/weld.exs --artifact outer_brain_contracts"
      ],
      "weld.release.track": [
        "weld.release.track build_support/weld.exs --artifact outer_brain_contracts"
      ],
      "weld.release.archive": [
        "weld.release.archive build_support/weld.exs --artifact outer_brain_contracts"
      ],
